...
% Given a model, evaluate the performance.
    ...
    addpath([baseDir, filesep, 'codes']);
        addpath([baseDir, filesep, 'codes', filesep, 'mir1k']);
    ...
    ModelPath=[baseDir, filesep, 'codes',filesep,'mir1k', filesep, 'demo'];
    ...
    test_mir1k_general_kl_bss3(eI.modelname, theta, eI, 'done', j);
